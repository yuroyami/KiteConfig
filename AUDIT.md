# kitessot: Deep Audit (v2, consolidated)
...
- **`RewriteSafety.writeTextSafely` / `writeAtomically`**: stage-to-temp + `ATOMIC_MOVE` with
  ...
  pristine copy always survives ([RewriteSafety.kt:27](src/main/kotlin/io/github/yuroyami/kitessot/RewriteSafety.kt#L27)).
- **`sanitizeInfoPlist`**: real DOM parser, external DTD/entity loading disabled (XXE-safe),
  ...
  ([PlistSanitize.kt:46](src/main/kotlin/io/github/yuroyami/kitessot/PlistSanitize.kt#L46)).
- **Literal replacement** via the lambda overload of `Regex.replace`: `$`/`\` in identity
  values cannot throw "Illegal group reference" ([PbxprojRewrite.kt:32](src/main/kotlin/io/github/yuroyami/kitessot/PbxprojRewrite.kt#L32)). Tested.
- **Left-anchored key regex + quoted-value alternation**: `MY_PRODUCT_NAME` never hit by a
  ...
  ([PbxprojRewrite.kt:43](src/main/kotlin/io/github/yuroyami/kitessot/PbxprojRewrite.kt#L43)). Tested.
- **`KGP_ON_CLASSPATH` guard**: compileOnly-KGP-in-a-sibling-classloader is real and subtle;
  ...
  ([KiteSsotPlugin.kt:478](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L478)).
- **`KmpAndroidLibraryWiring` isolated in its own class** so the AGP type never enters
  `KiteSsotPlugin`'s method descriptors: the plugin decorates even when AGP is absent
  ([KmpAndroidLibraryWiring.kt:29](src/main/kotlin/io/github/yuroyami/kitessot/KmpAndroidLibraryWiring.kt#L29)).
...
- **`deriveVersionCode` fail-fast** with actionable message, 32-bit ceiling rationale,
  `versionCodeOverride` escape hatch ([VersionCode.kt:22](src/main/kotlin/io/github/yuroyami/kitessot/VersionCode.kt#L22)).
...
- **`srcDir(genTask.flatMap { outputDir })` wiring** for the IO worker: dependency carried to
  every consumer of the source set ([KiteSsotPlugin.kt:237](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L237)).
...
([PbxprojRewrite.kt:21](src/main/kotlin/io/github/yuroyami/kitessot/PbxprojRewrite.kt#L21)).
...
- `onlyIf { ext… }` capturing the extension does NOT break CC storage: `KiteSsotExtension` is
...
> Type 'io.github.yuroyami.kitessot.GenerateIoWorkerTask' must be annotated either with
  @CacheableTask or with @DisableCachingByDefault.
```

`GenerateIoWorkerTask` ([GenerateIoWorkerTask.kt:20](src/main/kotlin/io/github/yuroyami/kitessot/GenerateIoWorkerTask.kt#L20))
...
([SharedModuleRewrite.kt:24](src/main/kotlin/io/github/yuroyami/kitessot/SharedModuleRewrite.kt#L24)).
...
with `kiteSsot { sharedModule = "composeApp" }` detects `oldName = "Utils"`, then rewrites the
...
"Shared module references migrated" even when zero files changed: [SyncIosConfigTask.kt:116](src/main/kotlin/io/github/yuroyami/kitessot/SyncIosConfigTask.kt#L116): misleading.)
...
([SyncAndroidLogoTask.kt:119](src/main/kotlin/io/github/yuroyami/kitessot/SyncAndroidLogoTask.kt#L119)).
...
knows two ancient files ([CleanupLegacyAppLogoArtifactsTask.kt:38](src/main/kotlin/io/github/yuroyami/kitessot/CleanupLegacyAppLogoArtifactsTask.kt#L38)).
...
variant using `backup = false` ([SyncIosLogoTask.kt:95](src/main/kotlin/io/github/yuroyami/kitessot/SyncIosLogoTask.kt#L95)).
...
rewrite": [KiteSsotExtension.kt:196](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotExtension.kt#L196))
...
- Android: the whole version block is gated on `ext.versionName.isPresent`
  ([KiteSsotPlugin.kt:408](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L408)).
- iOS: `versionCode` is passed to the rewriter only when `versionName.isPresent`, and
  ...
  `versionName != null` branch ([SyncIosConfigTask.kt:76](src/main/kotlin/io/github/yuroyami/kitessot/SyncIosConfigTask.kt#L76),
  [PbxprojRewrite.kt:46](src/main/kotlin/io/github/yuroyami/kitessot/PbxprojRewrite.kt#L46)).
...
**win over the SSOT** ([KiteSsotPlugin.kt:401](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L401)).
The KMP-native library path uses `finalizeDsl`, where the **SSOT wins**
([KmpAndroidLibraryWiring.kt:46](src/main/kotlin/io/github/yuroyami/kitessot/KmpAndroidLibraryWiring.kt#L46)).
...
([KiteSsotPlugin.kt:245](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L245)).
...
([KiteSsotPlugin.kt:376](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L376)).
...
`applyJavaVersion` writes only `compileOptions` ([KiteSsotPlugin.kt:460](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L460)).
...
([KiteSsotPlugin.kt:417](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L417), [:442](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L442)): deprecated in AGP 9 (catalog pins 9.2.1) in favour of `androidResources.localeFilters`.
...
### 3.10 🟡 CONFIRMED: changing `ioWorkerPackage` leaves the old generated file → duplicate `kiteSsotOffload` → JS compile error

`GenerateIoWorkerTask.generate` writes the new package path but never cleans `outputDir`
([GenerateIoWorkerTask.kt:42](src/main/kotlin/io/github/yuroyami/kitessot/GenerateIoWorkerTask.kt#L42)).
Gradle does not auto-delete stale files inside an `@OutputDirectory` on re-execution. Two
files, two top-level `kiteSsotOffload` declarations, one source set → "Conflicting overloads"
...
([KiteSsotPlugin.kt:101](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L101)).
...
([KiteSsotPlugin.kt:134](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L134)): a phone + Wear/TV pair collides on `applicationId` (install-blocking). Meanwhile the logo
...
- `check(target == target.rootProject)` throws `IllegalStateException`; `GradleException`
  frames it as user error, not plugin crash ([KiteSsotPlugin.kt:21](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L21)).
- `writeAtomically`'s comment claims a crashed temp file is "cleaned up next run via
  ...
  ([RewriteSafety.kt:74](src/main/kotlin/io/github/yuroyami/kitessot/RewriteSafety.kt#L74)). Sweep `*.kitessot.bak.tmp` siblings on entry, or fix the comment.
- Back-to-back plist inserts produce a blank line between entries (each append emits a
  ...
  minimal diff" ([PlistSanitize.kt:201](src/main/kotlin/io/github/yuroyami/kitessot/PlistSanitize.kt#L201)).
- `knownRegions` replacement hardcodes tab indentation ([PbxprojRewrite.kt:72](src/main/kotlin/io/github/yuroyami/kitessot/PbxprojRewrite.kt#L72)).
- `PACKAGE_NAME_RE` accepts Kotlin hard keywords (`web { ioWorkerPackage = "my.fun.gen" }`
  generates an uncompilable file) ([KiteSsotPlugin.kt:469](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotPlugin.kt#L469)).
- `kiteSsotVerify` reports identity + iOS files only: nothing about `android { }` SDK levels,
  `javaVersion`, logo config, or interop/web toggles ([KiteSsotVerifyTask.kt:38](src/main/kotlin/io/github/yuroyami/kitessot/KiteSsotVerifyTask.kt#L38)).
...
- Generated Blob-worker never calls `URL.revokeObjectURL`: one leaked object URL per
  `kiteSsotOffload` call ([IoWorkerGen.kt:45](src/main/kotlin/io/github/yuroyami/kitessot/IoWorkerGen.kt#L45)); no timeout either.
...
Write a generated `kitessot.xcconfig` (`MARKETING_VERSION`, `CURRENT_PROJECT_VERSION`,
`PRODUCT_NAME`, bundle id) into `build/generated/kitessot/`; the consumer includes it from the
...
Everything generated should land in `build/generated/kitessot/**` and be wired via source
...
### 4.4 ★ Close the loop to runtime: `KiteSsotBuildInfo` codegen into `commonMain`

The plugin already knows appName/versionName/versionCode/bundleIds/locales. Emit them as a
generated `object KiteSsotBuildInfo` so the About screen, crash tags, and analytics read the
same truth the build writes. Highest-value new feature per line of code; pairs with §4.3.

### 4.5 DSL/API revamp

- **Aggregate tasks**: `kiteSsotSync` (+ `kiteSsotSyncIos` / `kiteSsotSyncAndroid`): today users
  must know six task names.
- **`kiteSsotDoctor`**: one command validating the full setup (manifest placeholder present?
  plist keys point at `$(…)`? webp collisions? multiple app modules? KGP visible? region tags
  mappable?) with pass/fail + fix hints. `kiteSsotVerify` is the seed.
- **Gradle Problems API** for every warning the rewriters emit (build scans / IDE surface).
- **Naming coherence**: `syncIosConfig` / `sanitizeIosProject` / `kiteSsotVerify` /
  `cleanupLegacyAppLogoArtifacts` / `generateKiteSsotIoWorkerJs` share no prefix; unify under
  `kiteSsot*` (keep old names as deprecated aliases for one minor).
...
- `web { generateIoWorker }` is runtime coroutine infrastructure inside a configuration
  ...
  in BOTH": [IoWorkerGen.kt:17](src/main/kotlin/io/github/yuroyami/kitessot/IoWorkerGen.kt#L17)). Keep it if the
...
**Underdone**
- `kiteSsotVerify` (§3.13), single-strategy iOS integration (§3.7), no aggregate/doctor tasks,
...
14. §4.4 `KiteSsotBuildInfo` codegen. 15. §4.5 aggregate tasks + doctor + Problems API.
