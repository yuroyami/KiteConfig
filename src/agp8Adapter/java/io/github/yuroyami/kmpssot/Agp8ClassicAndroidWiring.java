...
final class Agp8ClassicAndroidWiring {
    ...
    static void wireApplication(Project project, KmpSsotExtension ext) {
        ...
        components.finalizeDsl(android -> {
            ...
            if (ext.getPropagateAndroidSdk().get()) {
                KmpSsotAndroidExtension sdk = ext.getAndroid();
    ...
    static void wireLibrary(Project project, KmpSsotExtension ext) {
