...
abstract class GenerateBuildConfigTask : DefaultTask() {
    ...
    fun generate() {
        ...
        if (dryRun.getOrElse(false)) {
            logger.info("[kiteSsot] dryRun does not suppress build-owned BuildConfig generation.")
        }
        ...
        logger.info("[kiteSsot] Generated KiteSsot build config: ${root.resolve(relative)}")
    }
}
