 ...
 */
internal enum class KiteSsotStyle(internal val code: String) {
 ...
 */
internal class KiteSsotConsole(private val colored: Boolean) {
     ...
     */
    fun paint(text: String, style: KiteSsotStyle): String =
    ...
    fun row(key: String, value: String, width: Int, indent: String): String =
        indent + paint(key.padEnd(width), KiteSsotStyle.KEY) + " = " + value
}
 ...
 *
 * @param explicit `-Pkitessot.color`, or null when unset.
