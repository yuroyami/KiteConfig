...
abstract class GenerateBuildConfigTask : DefaultTask() {
    ...
    fun generate() {
        ...
        if (dryRun.getOrElse(false)) {
            logger.info("[kiteConfig] dryRun does not suppress build-owned BuildConfig generation.")
        }
        ...
        logger.info("[kiteConfig] Generated KiteConfig build config: ${root.resolve(relative)}")
    }
}
