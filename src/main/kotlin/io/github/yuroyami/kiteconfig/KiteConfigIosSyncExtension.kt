 ...
 *
 * @see KiteConfigIosExtension for the values these tasks propagate.
 * @see PlistConflictPolicy for the policy this block selects.
 */
abstract class KiteConfigIosSyncExtension {
     ...
     * value.
     *
     * Default: [PlistConflictPolicy.FAIL], so KiteConfig never replaces a value
     * you did not agree to lose. [PlistConflictPolicy.KEEP] keeps what is there
     * and warns. [PlistConflictPolicy.REPLACE] lets KiteConfig overwrite it.
     *
     ...
     *
     * KiteConfig only writes the Boolean plist value. It does not determine your
