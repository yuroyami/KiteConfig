 ...
 * propagated into `Info.plist` by the explicit `kmpSsotSyncIosConfig` transaction
 * or the separately named `kmpSsotSanitizeIosProject` task: inserted when missing
