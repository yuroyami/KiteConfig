 ...
 * synthetic method descriptors. Were those on [KmpSsotPlugin] itself, Gradle would
 ...
 * module's own `android { }` block — so an SSOT value in `kmpSsot { }` overrides a
 ...
 * `kmpSsot { }` to keep whatever the module declares.
 */
